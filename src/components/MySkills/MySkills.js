    ...
    return (
        ...
        >
            <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white">
                <div data-aos="fade-right" className='md:mx-10 lg:mx-10'>
                ...
                <div data-aos="fade-left" className="w-full grid grid-cols-2 sm:grid-cols-4 gap-8 text-center py-8 lg:px-12 md:px-12 sm:px-0">
